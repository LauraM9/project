...
import static com.ocajexam.exercises.chapter11.PlanetPredicates.*;
...
public class PlanetApp {
	public static void main(String[] args) {
		...
		System.out.println("Has one or more rings: " + listFilteredPlanets(planetList, (Planet p) -> p.getRinged()));
		...
		// SCENARION 3 - Which planets have more than twenty moons?
